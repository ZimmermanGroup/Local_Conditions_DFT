...
url="http://www.thch.uni-bonn.de/tc.old/downloads/GMTKN/GMTKN55/CHARGE_MULTIPLICITY_G2RC.txt" #Link to molecules in dataset
...
correlation="GGA_C_SOGGA11" #correlation functional named in LibXC style
exchange="GGA_X_SOGGA11" #exchange functional named in LibXC style
